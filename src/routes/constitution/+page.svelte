...
<div class="constitution">
    <h1 class="noUnderscore">Dinosty League Constitution (Not Complelte or Accurate Yet)</h1>
    ...
    <p>Trading of players and draft picks are allowed. Trades will reviewed by either of the league commissioners and processes once they approved. Tradable assets include players & draft picks.</p>
    
    <h4 bind:this={oneTwoOne}>1.2.1 Trade Collusion</h4>
    <div class="subBlock">
        <p>We trust you. Don't do it.</p>
    ...
    <div class="subBlock">
        <p>All vetos will be handle by commissioners.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $100, and the offseason with another $100. $0 bids are allowed. Bids will process everyday, Tuesday-Sunday at 9AM CST during the season and Sundays at 7pm CST in the offseason.</p>
