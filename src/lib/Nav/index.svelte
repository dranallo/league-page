...
<svelte:head>
	<title>{!$page.url.pathname[1] ? 'Home' : $page.url.pathname[1].toUpperCase() + $page.url.pathname.slice(2)} | Blood, Sweat, and Beers</title>
</svelte:head>
...
<nav>
	<a href="/"><img id="logo" alt="league logo" src="./bsb.jpg" /></a>
